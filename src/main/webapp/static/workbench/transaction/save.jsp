	...
	<script type="text/javascript">
		$(function () {
            ...
            $("#create-stage").change(function () {
				let key = $("#create-stage").val();
                $.ajax({
                    url:"/Tran/possibility",
                    type:"get",
                    data:{
                        "key":key,
					},
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="9bec62388e88440ba5f6075e1e5deedf">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="d028a43ac33c4ac68fab432cf60dc18d">
			</div>
		</div>
